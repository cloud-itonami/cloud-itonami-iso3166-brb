(ns marketentry.phase
  "Phase 0->3 staged rollout for the Barbados (BRB) market-entry
  compliance actor.
  ...
  real portal package (gov-bb.bonfirehub.com vendor/tender submission)
  and submitting a real registration/filing are the two real-world
  acts this actor performs; both are always a human market-entry
  operator's call. `marketentry.governor`'s `:actuation/draft-filing`/
